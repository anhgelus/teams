...
public class TeamsCreateScreen extends TeamsInputScreen {
    ...
    private static final Text CREATE_TITLE = new TranslatableText("teams.menu.create.title");
    private static final Text CREATE_TEXT = new TranslatableText("teams.menu.create.text");
